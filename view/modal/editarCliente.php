...
?>
<form method="post" id="editar_cliente" name="editar_cliente" autocomplete="off" class="form-horizontal form-validate">
         ...
         <div class="modal-content bg-white">
            ...
            <div class="modal-body">
              <div id="resultados_ajax2"></div>
               <div class="form-row">
                  <input type="hidden" name="mod_idcli" id="mod_idcli">
