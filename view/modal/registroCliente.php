              ...
              <div id="resultados_ajax2"></div>
               ...
               <div class="form-row">
                   <div class="form-group col-md-6">
                       ...
                       <input type="hidden" class="form-control input-sm" id="cliente_ubigeo" name="cliente_ubigeo" autocomplete="off" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ubigeo">
                   </div>
                   <div class="form-group col-md-6">
