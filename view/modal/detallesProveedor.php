<div class='modal fade' id='detallesProveedor' tabindex='-1' role='dialog' aria-labelledby='exampleModalCenterTitle' aria-hidden='true'>
          ...
          <input type='hidden' name='id_proveedor' id='id_proveedor'>
           <div class='row align-items-center'>
              <div class='col-12 col-md-4'>
                  <img src='../img/client/provider.png' class='img-fluid'>
              </div>
