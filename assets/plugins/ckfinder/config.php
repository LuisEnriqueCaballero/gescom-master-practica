...
$config['licenseName'] = '';
$config['licenseKey']  = '*2?4-*1**-J**K-*J**-*3**-4*K*-2**9';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $ruta.'/view/archivos/'.$tienda.'/',
...
$config['resourceTypes'][] = array(
    'name'              => 'Documentos', // Single quotes not allowed.
    'directory'         => 'documentos',
    'maxSize'           => 0,
    'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,svg,psd',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'imagenes',
    'maxSize'           => 0,
    'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,svg,psd',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'musica',
    'maxSize'           => 0,
    'allowedExtensions' => 'mp3,mid,wav,wma,cda,ogg,ogm,aac,ac3,flac,aym',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'videos',
    'maxSize'           => 0,
    'allowedExtensions' => 'asf,mp4,mpe,mpeg,mpg,avi,wmv',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
