...
$data = file_get_contents("http://api.ateneaperu.com/api/Sunat/Ruc?sNroDocumento=".$documento_colaborador."&fbclid=IwAR3lSx_0i-U7gBGUDZAY7kbM9IMJyDzCLt8IR0BodgRvHaouPu5UgytbqFg");
$info = json_decode($data, true);

if($data==='[]'){
	$datos = array(0 => $info['ruc'] == '');
	//echo 'nada';
