...
<script>
    $('#example').DataTable( {
        "ajax": '../ajax/seleccionarSucursal1.php',
        "lengthMenu": [
            [10, 15, 20, -1],
            ['10', '15', '20', 'Todo']
        ],
        "language": {
            ...
            "sInfoPostFix":   "",
            "sSearch":        "<a onclick='load(1);' style='cursor: pointer; height:30px; font-size: 12px;' class='btn btn-info'><i class='la la-refresh' style='color: #fff; margin-top: -5px;'></i></a>",
