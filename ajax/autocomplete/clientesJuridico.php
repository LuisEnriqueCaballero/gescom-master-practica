...
/* If connection to database, run sql statement. */
    if ($con) {
        ...
        $fetch = mysqli_query($con, "select * from clientes where cliente_tipo='4' and cliente_nombre like '%" . mysqli_real_escape_string($con, ($_GET['term'])) . "%' or cliente_documento like '%" . mysqli_real_escape_string($con, ($_GET['term'])) . "%' LIMIT 0 ,50");
