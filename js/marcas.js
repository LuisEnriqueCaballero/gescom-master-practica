...
$(document).prop('title', '.:: Marcas | Prizma Technology ::.');
//
...
$('#eliminarMarca').on('show.bs.modal', function (event) {
...
function obtener_datos(id) {
  var nom_marca = $('#nom_marca' + id).val();
  var desc_marca = $('#desc_marca' + id).val();
