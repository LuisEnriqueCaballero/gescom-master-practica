...
$(document).prop('title', '.:: PCGE | Miracles ::.');
...
function load(page) {
  ...
  $.ajax({
    url: '../ajax/buscarPCGE.php?action=ajax&page=' + page + '&q=' + q,
    beforeSend: function (objeto) {
      $('#ldng_cat').html(
        '<img src="../img/company/pacman.gif" style="width: 50px;"> &nbsp; Buscando Plan Contable...'
      );
